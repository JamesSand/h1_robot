...
class H1Cfg(LeggedRobotCfg):
    ...
    class terrain(LeggedRobotCfg.terrain):
        curriculum = False # do not use curriculum training
        mesh_type = 'plane'
    ...
    class commands(LeggedRobotCfg.commands):
        ...
        heading_command = False # fix heading 
        ang_vel_command = True

        class ranges:
            # fix heading
            # only consider linear vel, and angle vel
    ...
    class control(LeggedRobotCfg.control):
        ...
        action_scale = 1.0
        exp_avg_decay = None
        decimation = 10 # since we have 10 joint?

    class domain_rand(LeggedRobotCfg.domain_rand):
        # no random friction and random mass
        # only randome push robot
        ...
        # shorter push interval, 15 in legged robot
        # smaller push vel, 1 in legged robot
        push_robots = True
        push_interval_s = 2.5
        max_push_vel_xy = 0.5
    ...
    class asset(LeggedRobotCfg.asset):
        ...
        # here is False, which means do not merge bodies
    ...
    class rewards(LeggedRobotCfg.rewards):
        ...
        class scales(LeggedRobotCfg.rewards.scales):
            ...
            # pb gamma reward, all set to 1.0
...
class H1CfgPPO(LeggedRobotCfgPPO):
    ...
    class algorithm(LeggedRobotCfgPPO.algorithm):
        ...
        # learning rate is lower, legged is 1e-3
        learning_rate = 1.e-5
